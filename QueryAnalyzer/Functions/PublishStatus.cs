...
{
    [Function("PublishStatus", Example = "PublishStatus() from /sitecore/content/*",
        LongHelp = "Checks if the item exist in target database",
        ShortHelp = "Checks if the item is published and return the status")]

    public class PublishStatus : IFunction
    {
