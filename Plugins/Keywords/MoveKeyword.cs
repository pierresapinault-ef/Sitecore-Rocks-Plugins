...
{
    [Keyword("move", 282,
        Example = "move item to(id,'{110D559F-DEA5-42EA-9C1C-8A5DF7E70EF9}') from /sitecore/content//*[@@templatename='Sample Item']",
        LongHelp = "Move items to the desired location\nYou can specify an ID or a path for the target location",
        ShortHelp = "Move items",
        Syntax = "'move' 'item' 'to' ('\"id\" or \"path\"',[value]) from [expression]")]
